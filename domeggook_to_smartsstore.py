...
def main():
    ...
    print(f"categories_no type: {type(categories_no)}")
    print(f"categories_no sample item type: {type(categories_no[0])}")
    print(f"categories_no sample item: {categories_no[0]}")
